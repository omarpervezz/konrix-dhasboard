...
if (document.getElementById("sweetalert-basic"))
    document.getElementById("sweetalert-basic").addEventListener("click", function () {
        Swal.fire({
            ...
            confirmButtonClass: 'btn bg-primary inline-flex items-center justify-center rounded border border-transparent py-2 px-4 text-center text-sm leading-5 font-medium transition duration-150 ease-in-out text-white w-xs mt-2',
...
if (document.getElementById("sweetalert-success"))
    document.getElementById("sweetalert-success").addEventListener("click", function () {
        Swal.fire({
            ...
            confirmButtonClass: 'btn bg-primary inline-flex items-center justify-center rounded border border-transparent py-2 px-4 text-center text-sm leading-5 font-medium transition duration-150 ease-in-out text-white w-xs me-2 mt-2',
            cancelButtonClass: 'btn bg-danger inline-flex items-center justify-center rounded border border-transparent py-2 px-4 text-center text-sm leading-5 font-medium transition duration-150 ease-in-out text-white w-xs mt-2',
            buttonsStyling: false,
            showCloseButton: false
        })
    });
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                Swal.fire({
                    ...
                    icon: 'error',
                    confirmButtonClass: 'btn bg-primary inline-flex items-center justify-center rounded border border-transparent py-2 px-4 text-center text-sm leading-5 font-medium transition duration-150 ease-in-out text-white mt-2',
                    buttonsStyling: false
                })
            }
        });
